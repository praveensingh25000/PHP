...
function program1(depth0,data) {
  ...
  options = {hash:{},data:data};
  buffer += escapeExpression(((stack1 = helpers.ternary || depth0.ternary),stack1 ? stack1.call(depth0, "Go to bid", "Start bid", depth0.hasBid, options) : helperMissing.call(depth0, "ternary", "Go to bid", "Start bid", depth0.hasBid, options)))
    + "</a>\r\n";
  return buffer;
  });
